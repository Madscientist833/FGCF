...
def setup(args):
    ...
    model = VisionTransformer(config, args.img_size, zero_head=True, num_classes=num_classes,                                                   smoothing_value=args.smoothing_value, fusion_way=args.fusion_way)
...
def main():
    ...
    parser.add_argument('--fusion_way', type=str, default='mul',
                        help="How to fuse attention map in part selection module; selected in ['matmul','mul','add','lastlayer']")
